...
# -------------------------------------------------
theta38 = bp38**4 * caf2**5 * nd2 * nd3 * A * omegaBF
theta85 = bp85**4 * caf2**5 * nd2 * nd3 * A * omegaBF
theta185 = bp185**5 * nd1 * nd3 * znse**2 * A * omegaBF
theta25 = bp25**3 * lp * sp_a**3 * sp_b * A * omegaADR
