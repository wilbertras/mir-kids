...
R_filter = np.array([83.47,83.47,83.55,13.48])
R = np.sqrt(1/(1/R**2 - 1/R_filter**2))
...
ax.scatter(25, 2.92, label='Day et al. (2024)', marker='D', linewidth=2, facecolor='None', edgecolor='p', zorder=-3)
